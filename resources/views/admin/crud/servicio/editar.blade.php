                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" id="nombre" name="nombre" required="required" class="form-control col-md-7 col-xs-12" value="{{$bag['servicio']->nombre}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <input type="text" id="total" name="total" required="required" class="form-control col-md-7 col-xs-12" value="{{$bag['servicio']->total}}">
                                    </div>
                                </div>
                            </div>
